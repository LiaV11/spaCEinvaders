...
int checkCollision(Bullet* bullet,
                   Alien* alien) {
...
int bulletHitsBunker(Bullet* bullet,
                     Bunker* bunker) {
    ...
    return bullet->x <
           ...
           bullet->y <
           bunker->y + bunker->height &&

           bullet->y + 20 >
           bunker->y;
}

int checkUFOCollision(Bullet* bullet,
                      UFO* ufo) {
...
void showGameOverScreen(SDL_Window* window,
                        int score) {
...
void showWinScreen(SDL_Window* window,
                   int score) {
        ...
        */
        ...
        for (int i = 0;
            ...
            if (checkCollision(
                ...
                aliens[i].exploding = 1;

                aliens[i].explosionTimer = 20;
